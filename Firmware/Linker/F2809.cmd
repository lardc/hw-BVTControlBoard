...
PAGE 0:    /* Program Memory */
   ...
   BEGIN        : origin = 0x3E8000, length = 0x000002     /* Part of FLASHCD. Entry point for main firmware */
   FLASHCD      : origin = 0x3E8002, length = 0x007FFE     /* on-chip FLASH */
...
SECTIONS
{
   ...
   IQmathTablesRam     : LOAD = FLASHCD, PAGE = 0
                         RUN = RAMM0, PAGE = 1
